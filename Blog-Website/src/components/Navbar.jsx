...
const Navbar = () => {
  ...
  return (
    <div className='w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-7 mb-13 py-6 sm:py-2 md:py-3 lg:py-7 bg-gray-200'>
    <header className=' bg-white text-black top-0 right-0 left-0 rounded-3xl shadow-xl'>
