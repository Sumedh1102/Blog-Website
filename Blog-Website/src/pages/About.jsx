...
import video10 from '../components/video10.mp4'
  ...
  return (
    ...
    <div className="container px-4 md:px-6 mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative h-auto md:h-auto rounded-xl overflow-hidden">
          <img
            src={image11}
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold tracking-tighter">Discover a World of Investment Opportunities</h2>
              <p className="text-gray-600">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis,
                pulvinar dapibus leo. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
      ...
      <section className="w-full py-12 md:py-24 lg:py-38 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-10">
            <div className="text-sm font-medium uppercase tracking-wider text-gray-500 mb-2">SOLUTION</div>
            <h2 className="text-4xl font-bold tracking-tighter">Smart Investment Solutions</h2>
          ...
          {/* Stats */}
          <ScrollTrigger onEnter={() => setCounterStart(true)} onExit={() => counterStart(false)}>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="space-y-2">
              <div className="text-4xl md:text-5xl font-bold">
                {
                  counterStart && <CountUp start={0} end={35}></CountUp>
                }
